// config/airtable.js
// Configuration Airtable v8.2 — Pipeline profil cognitif (20 mars 2026)
//
// CORRECTIONS v8.2 :
...
module.exports = {
  ...
  VISITEUR_FIELDS: {
    ...
    backup_before_boucles:      'backup_before_boucles',
    backup_after_boucles:       'backup_after_boucles',
  ...
  BILAN_FIELDS: {
    ...
    // P1_simples_synthese déjà déclaré dans la section Algo ci-dessus
    anticipation_niveau:           'anticipation_niveau',
    ...
    // Piliers certifiés par le Certificateur (Prompt 2)
    pilier_dominant_certif:        'pilier_dominant_certif',
    pilier_structurant_certif:     'pilier_structurant_certif',
    pilier_structurant2_certif:    'pilier_structurant2_certif',
