...
module.exports = {
  ...
  MAX_TOKENS: {
    ...
    agent_testdec_gen:       16000,  // ⭐ Étape 2c v2.0 (09/07) — 4 moments (~5k tokens de sortie) : réflexion bornée → génération en 2-4 min réels. Plafond ABAISSÉ une seconde fois (était 28000).
