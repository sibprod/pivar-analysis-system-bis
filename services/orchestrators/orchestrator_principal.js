...
async function aiguillerVersSousOrchestrateur({ candidat_id, visiteur, statut_actuel }) {
  ...
  // ─── ⭐ v10.9 — Aiguillage Étape 2 (refonte en phases) ───────────────────
  // Les statuts ci-dessous sont tous gérés par orchestratorEtape2 qui détecte
  // automatiquement le mode (COMPLET / PHASE1_ISOLEE / PHASE2_ISOLEE / PHASE3_ISOLEE
  // / PHASE4_ISOLEE) à partir du statut entrant via la table STATUT_TO_MODE.
  //
  // ⭐ v10.9 (22/05/2026) : ajout de REPRENDRE_AGENT2_PHASE3 (mode PHASE3_ISOLEE).
  // ⭐ v10.8 (18/06/2026) : ajout de REPRENDRE_AGENT2_CIRCUITPOURBILAN (mode PHASE4_ISOLEE)
  //   qui grave la table ETAPE1_T2_CIRCUITS_POURBILAN (mission de fin d'étape 1.2).
  //   Cf. orchestratorEtape2.js v10.10.
  const STATUTS_ETAPE_2 = [
    ...
    'REPRENDRE_AGENT2_CIRCUITPOURBILAN'    // ⭐ v10.8 (18/06/2026) — Mode PHASE4_ISOLEE : mission de fin d'étape 1.2 (grave ETAPE1_T2_CIRCUITS_POURBILAN) → ETAPE2_TERMINEE
  ];
