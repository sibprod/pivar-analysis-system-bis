...
async function buildPayload(candidat_id) {
  ...
  // Map pilier (P1..P5) → suffixe rôle CSS (socle/str1/str2/fn1/fn2) pour placer les branches du soleil
  const ROLE_TO_CSS = { socle:'socle', structurant_1:'str1', structurant_2:'str2', fonctionnel_1:'fn1', fonctionnel_2:'fn2' };
  const pilierToRoleCss = {};
  for (const pr of pilierRows) { pilierToRoleCss[pr.pilier] = ROLE_TO_CSS[pr.role_pilier] || 'fn2'; }
