...
// File d'attente d'analyse — Profil-Cognitif v10.0
//
...
//     (statut_analyse_pivar = 'NOUVEAU', 'REPRENDRE_AGENT1', 'REPRENDRE_VERIFICATEUR1')
...
async function runPollingCycle() {
  ...
  try {
    ...
    // ⭐ v10 : Statuts élargis (Décisions n°16, n°24)
    ...
    for (const c of candidates) {
      ...
      // Priorité HIGH pour les retry/reprise
