...
module.exports = {
  ...
  RESPONSES_FIELDS: {
    ...
    boucles_detectees_agent3:  'boucles_detectees_agent3',  // version structurelle Agent 3
    ...
    piliers_actives_final:   'piliers_actives_final',       // renommé depuis circuits_actives_pilier_coeur
    boucles_detectees_agent1: 'boucles_detectees_agent1',   // version narrative Agent 1
  ...
  BILAN_FIELDS: {
    ...
    // Champs synthèse globale — colonnes dédiées
