...
// ═══════════════════════════════════════════════════════════════════════════
const ENGAGEMENT = 'Vous vous sentez concerné{{E}} et vous voulez contribuer au mieux, à votre façon.';
...
const OUVERTURE_TPL = [
  ...
  '',
  'Quatre moments du week-end vont suivre. À chaque fois : ce qui se passe, qui gère quoi, votre objectif — puis racontez ce que vous faites et ce que vous dites, concrètement. Il n\'y a pas de bonne attitude. Une réponse validée est définitive.'
].join('\n');
...
const MOMENTS = [
  {
    ...
    situation: [
      ...
      '',
      'Qui gère quoi : la journée de samedi — et tout ce qui la concerne — est la mission d\'Orga : cette information le regarde, c\'est à lui de la gérer. Vous, vous portez le séjour dans son ensemble, et ce soir vous êtes disponible.',
      '',
      'Votre objectif : que samedi soit une réussite pour tout le groupe — Terrien compris. ' + ENGAGEMENT
    ].join('\n'),
  ...
  },
  {
    ...
    situation: [
      ...
      '',
      'Qui gère quoi : dimanche est votre mission commune, à parts égales — ni la vôtre, ni la sienne : la journée doit être décidée ensemble.',
      '',
      'Votre objectif : un dimanche prêt ce soir et réussi pour tout le groupe. ' + ENGAGEMENT
    ].join('\n'),
  ...
  },
  {
    ...
    situation: [
      ...
      '',
      'Qui gère quoi : le repas de ce soir est sa mission — le menu et la cuisine lui appartiennent. Vous, vous l\'accompagnez aux courses ; l\'envie du groupe, vous l\'avez entendue comme tout le monde.',
      '',
      'Votre objectif : un dîner réussi ce soir — convivialité et plaisir pour tout le groupe, le chef compris. ' + ENGAGEMENT
    ].join('\n'),
  ...
  },
  {
    ...
    personnage: 'récit — Orga, Boussole, Vegan Chef',
    situation: [
      'MOMENT 4 / 4 — Le retour',
      '',
      'Ce qui se passe : dans le train du retour, un proche qui connaît tout le groupe — votre fille, par exemple — vous appelle : « Alors, ce week-end ? Raconte ! » Vous racontez les trois moments qui ont fait l\'histoire du séjour : la surprise de samedi (la montgolfière — et le cas Terrien), la journée de dimanche construite avec Boussole, et le dîner de Vegan Chef (l\'envie barbecue du groupe).',
      '',
      'Votre récit, pour chacune des trois histoires, raconte les trois choses suivantes :',
      '1. Le problème — ce qui coinçait, dit simplement ;',
      '2. Comment chacun a fait, à sa façon — comment Orga s\'y est pris avec l\'information et sa surprise, sa manière à lui ; comment Boussole a mené la journée, sa manière à elle ; comment Vegan Chef a répondu à l\'envie du groupe, sa manière de chef ;',
      '3. Ce que vous avez fait, vous — votre part dans l\'histoire, et comment ça s\'est fini.'
    ].join('\n'),
    question: 'Racontez comme on raconte vraiment à quelqu\'un qui connaît tout le monde — vivant, concret, avec ce qui vous a surpris{{E}} chez l\'un ou chez l\'autre.',
    amorce: 'Alors, la surprise de samedi, tu ne devineras jamais :'
  }
];
