...
// ─── VÉRIFICATEUR (Lot D) — écriture des colonnes verif_* (surcharge) ────────
// Écrit les corrections du vérificateur sur le record BILAN existant (par recordId).
// fieldsVerif = { verif_filtre, verif_soleil, verif_boucles, verif_synthese, verif_pilier_socle_mode,
//                 verif_rapport, verif_statut } (seulement les clés présentes).
...
// Écrit les corrections verif_* sur les records PILIER (par recordId, depuis pilierMap pilier→recordId).
// piliersVerif = { P1: { verif_pilier_mode, verif_synth_factuelle, verif_synth_interpretee, verif_tableau_note }, ... }
...
module.exports = {
  ...
  // VÉRIFICATEUR (Lot D) — écriture des colonnes verif_*
  writeVerifBilan,
  writeVerifPiliers,
