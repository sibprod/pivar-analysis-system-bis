...
> **La narration contient-elle un deux-points, ou dépasse-t-elle 150 caractères ?**
> **OUI → il FAUT un titre.** **NON → pas de titre.**

Ce n'est pas une appréciation. Un passage a rendu **douze gestes sur treize sans titre** alors que sept d'entre eux étaient des paragraphes de plusieurs lignes : la règle « paragraphe ou phrase » laissait trop de place au jugement.
...
7. **Tout geste dont la narration dépasse 150 caractères ou contient un deux-points PORTE un titre.** Compte-les avant de rendre.
