...
## ENTRÉE
Les 25 lignes T5A du candidat (`candidat_id`, `id_question`, `scenario`, et pour DEC : `DEC_niveau`, `DEC_verbatim`, `DEC_manifestation`). Tu produis uniquement l'objet T5B de DEC.
