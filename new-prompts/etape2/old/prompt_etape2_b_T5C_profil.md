...
>
> 🔒 **RÈGLE TEMPORELLE DU DÉFAVORABLE MANAGEMENT (garante, 03/07).**
> Côté management, `DÉFAVORABLE` n'est autorisé QUE si la ligne DEC atteste une
...
> management qui aboutirait à DÉFAVORABLE s'écrit `RÉSERVE DE PROTOCOLE`, avec
...
> est ouverte, DÉFAVORABLE compris — verdict interne lu par le recruteur,
...
- **DÉFAVORABLE** = inadéquation de fondatrice **constatée**. On constate une inadéquation, on ne brandit pas un « danger ».
