...
## ENTRÉE
Les 25 lignes T5A du candidat (`candidat_id`, `id_question`, `scenario`, et pour ANT : `ANT_niveau`, `ANT_verbatim`, `ANT_manifestation`). Tu produis uniquement l'objet T5B de ANT.
