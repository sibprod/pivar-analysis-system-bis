...
Format (JSON dans le champ) :
`[ { "niveau":"ÉLEVÉ", "scenario":"PANNE", "q":23, "texte":"verbatim exact" } ]`
...
## ENTRÉE
Les 25 lignes T5A du candidat (`candidat_id`, `id_question`, `scenario`, et pour VUE : `VUE_niveau`, `VUE_verbatim`, `VUE_manifestation`). Tu produis uniquement l'objet T5B de VUE.
